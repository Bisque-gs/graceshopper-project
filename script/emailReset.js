...
<table class="main" width="100%">
    ...
    <td style="padding: 0px 50px; text-align:center">
      ...
      <p style="padding: 0px 50px">
        This email address was recently used to reset password on PokEbay. If this was you, please press the button below to create a new password:
      </p>
