...
<table class="main" width="100%">
    ...
    <td style="padding: 0px 50px; text-align:center">
      ...
      <p style="padding: 0px 50px">
        This email address was recently used to update your profile on PokEbay. If this was you, please feel free to use your account:
      </p>
      <a href="https://grace-pokebay.herokuapp.com/login" class="button">Login</a>
      <p>
        If this was not you, you can safely ask for help at (800)888-8888 🤣
      </p>
    </td>
    </tr>
...
module.exports = emailAccChanged;